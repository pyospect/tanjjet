...
The final pipeline checks or applies the strict Supabase migration, runs release verification, removes rebuildable DerivedData caches, recreates the archive, uploads to TestFlight, and then reruns the release-readiness audit.
